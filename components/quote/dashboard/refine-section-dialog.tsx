...
/* Refine-section wizard — a small in-page dialog that sharpens ONE quote section.
   It sends the live quote content (including unsaved inline edits) to the AI, asks
   a couple of targeted questions, then stages the refined fields back into the
   dashboard's edit state via onApply. Mirrors the PRD refine-section-dialog. */
        ...
        {state.kind === "idle" && (
          <>
            ...
            <div className="px-6 py-4 text-sm text-neutral-600">
              The AI will read the full quote (including your unsaved edits) and ask a couple of focused questions before rewriting just this section. Nothing is saved until you click Save draft.
            </div>
            <DialogFooter>
              <Button variant="outline" onClick={() => onOpenChange(false)}>Cancel</Button>
