...
/* Rail layout for the quote dashboard — a sticky table-of-contents with
   scroll-spy alongside the full section list. Mirrors prd-rail.tsx. */

import { useState, useRef, useEffect } from "react";
import { Sparkles } from "lucide-react";
import type { QuoteContent } from "@/lib/types";
import { isRefinable } from "@/lib/quote/section-fields";
import { SECTIONS, type SectionDef, type QuotePatch } from "./quote-sections";
