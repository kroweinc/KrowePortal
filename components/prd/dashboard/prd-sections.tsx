...
import type { PrdContent, PrdPriority, PrdStackItem, FreeTierAssumption, FreeTierAnalysis, PrdMilestone } from "@/lib/types";
import {
...
import { fillStack, fillIntegration } from "@/lib/prd/fill-lookup";
...
/** fillStack / fillIntegration — merge a lookup result into a §9 stack row / §8
    integration row — live in lib/prd/fill-lookup.ts so the agent's swap_prd_tech
    tool reuses the exact same merge. */
